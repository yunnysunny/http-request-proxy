...
/** 
  ...
  * @property {Boolean=} [beforeParser=false]
  ...
  */
/**
  * @typedef {Object} ProxyUrl 
  * @property {String|ProxyUrlProcess} url
  *
  */
/**
 * @typedef { CommonOptions} CustomOptions
 * 
 * @property {String|ProxyUrlProcess} url
 */
/**
 * @typedef {Object} UrlsToProxy
 * @property {Object.<String, String | ProxyUrlProcess | CustomOptions>} urlsToProxy
 */

/**
 * @typedef {CommonOptions} PorxyOptionsInit
 *
 * @property {Object.<String, String | ProxyUrlProcess | CustomOptions>} urlsToProxy
 */
